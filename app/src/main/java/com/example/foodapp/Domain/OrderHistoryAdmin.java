...
//    }
//}
public class OrderHistoryAdmin {
    private String orderId;
    private String orderTime;
    private int totalPrice;
    ...
    public OrderHistoryAdmin(String orderId, String orderTime, int totalPrice, List<String> imageUrls, List<String> foodTitles, List<Integer> soluongs,List<Double> price,String status) {
        this.orderId = orderId;
        this.orderTime = orderTime;
        this.totalPrice = totalPrice;
