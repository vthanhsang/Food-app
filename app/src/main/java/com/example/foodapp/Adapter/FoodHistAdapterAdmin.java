...
public class FoodHistAdapterAdmin extends RecyclerView.Adapter<FoodHistAdapterAdmin.FoodViewHolder> {
    private List<String> foodTitles;
    private List<Integer> quantities;
    private List<String> imageUrls;

    private List<Double> price;
    public FoodHistAdapterAdmin(List<String> foodTitles, List<Integer> quantities, List<String> imageUrls,List<Double> price) {
